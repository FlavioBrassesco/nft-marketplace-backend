...
export interface NativeMetaTransactionCalldataInterface
  extends utils.Interface {
  functions: {
    "ERC712_VERSION()": FunctionFragment;
    "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8)": FunctionFragment;
    "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "executeMetaTransaction(address,bytes,bytes32,bytes32,uint8,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>,
...
export interface NativeMetaTransactionCalldata extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NativeMetaTransactionCalldataInterface;
